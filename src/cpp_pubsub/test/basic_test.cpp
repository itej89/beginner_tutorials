...
TEST_F(TaskPlanningFixture, TrueIsTrueTest) {
   ...
   */
  using SUBSCRIBER = rclcpp::Subscription<cpp_pubsub_msgs::msg ::TutorialString>::SharedPtr;
  bool hasData = false;
  SUBSCRIBER subscription = node_->create_subscription<cpp_pubsub_msgs::msg ::TutorialString>
  ("custom_message", 10,
